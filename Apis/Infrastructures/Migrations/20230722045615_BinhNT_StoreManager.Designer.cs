...
namespace Infrastructures.Migrations
{
    ...
    [Migration("20230722045615_BinhNT_StoreManager")]
    partial class BinhNT_StoreManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Store", b =>
                {
                    ...
                    b.HasIndex("StoreManagerId")
                        .IsUnique()
                        .HasFilter("[StoreManagerId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.StoreManager", b =>
                {
                    b.HasBaseType("Domain.Entities.BaseUser");
            ...
            modelBuilder.Entity("Domain.Entities.Store", b =>
                {
                    b.HasOne("Domain.Entities.StoreManager", "StoreManager")
                        .WithOne("Store")
                        .HasForeignKey("Domain.Entities.Store", "StoreManagerId");
            ...
            modelBuilder.Entity("Domain.Entities.StoreManager", b =>
                {
                    b.HasOne("Domain.Entities.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.StoreManager", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
